...
export default function UploadSimple() {
  ...
  const uploadMutation = trpc.upload.processSimpleExcel.useMutation({
    onSuccess: (data) => {
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">
              Subir Archivo Excel (Formato Simplificado)
            </h1>
            ...
            <CardContent>
              <ul className="space-y-2 mb-6">
                <li className="flex items-start">
                  ...
                  <span><strong>Full Name</strong> (requerido): Nombre completo del investigador</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-primary rounded-full mt-2 mr-3"></span>
                ...
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-primary rounded-full mt-2 mr-3"></span>
                  <span><strong>Country</strong> (opcional): Código de país (ej: AR, CL, MX)</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 bg-primary rounded-full mt-2 mr-3"></span>
                  <span><strong>Universidad</strong> (opcional): Institución del investigador</span>
                </li>
              </ul>

              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                <p className="text-sm text-blue-800">
                  <strong>Nota:</strong> El nombre completo se dividirá automáticamente en nombre y apellido. 
                  El sistema asume que la última palabra es el apellido.
                </p>
              </div>
